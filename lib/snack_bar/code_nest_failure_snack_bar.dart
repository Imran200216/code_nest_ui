...
class CodeNestFailureSnackBar extends SnackBar {
  CodeNestFailureSnackBar({
    super.key,
    Widget? leading,
    required String message,
    Color super.backgroundColor = const Color(0xFFB00020),
    Color textColor = Colors.white,
    Color closeIconColor = Colors.white, // Add this for close icon color
    super.duration,
    String? actionLabel,
